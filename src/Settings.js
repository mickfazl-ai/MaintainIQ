  ...
  return (
    <div style={{ maxWidth: 960 }}>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontSize: 24, fontWeight: 800, color: 'var(--text-primary)', margin: '0 0 4px' }}>Settings</h2>
        <p style={{ fontSize: 13, color: 'var(--text-muted)', margin: 0 }}>Manage your company profile, team and account preferences.</p>
      </div>
